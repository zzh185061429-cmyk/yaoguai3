...
import {
  ...
  ChevronDown, ChevronUp, HelpCircle, MapPin, Calendar,
} from 'lucide-react';
...
export function HUD({
  ...
  onOpenSettings, onOpenManual, onOpenMap, onOpenCalendar,
          ...
          >
            <div className={cn("flex items-center", isMobile ? "gap-0.5 justify-between" : isLarge ? "gap-2" : "gap-1")}>
              ...
              <ToolButton
                ...
                title="地图"
                label="地图"
                color="bg-ink-800 border-cyan-900/50"
                textColor="text-cyan-400"
                isMobile={isMobile}
                isLarge={isLarge}
                icon={<MapPin className={ci} />}
              />
              <ToolButton
